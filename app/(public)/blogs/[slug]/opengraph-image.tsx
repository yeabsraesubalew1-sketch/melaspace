				...
				>
					<div style={{ display: "flex", justifyContent: "space-between", gap: 32 }}>
						...
						<div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 210, height: 210, borderRadius: 40, background: "rgba(90,67,56,0.06)", border: "1px solid rgba(90,67,56,0.1)" }}>
							<div style={{ width: 136, height: 136, borderRadius: 999, border: "7px solid rgba(90,67,56,0.78)", position: "relative" }}>
								<div style={{ position: "absolute", inset: 26, borderRadius: 999, border: "7px solid rgba(90,67,56,0.38)" }} />
							</div>
						</div>
					</div>

					<div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 980 }}>
						<div style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 74, fontWeight: 700, lineHeight: 1.04, letterSpacing: -1.5 }}>
							{title}
						</div>

						<div style={{ fontSize: 28, lineHeight: 1.45, opacity: 0.86, maxWidth: 900 }}>
							{excerpt}
						</div>
