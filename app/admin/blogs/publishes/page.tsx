...
export default async function AdminPublishedBlogsPage({
  searchParams,
}: {
    ...
    return (
      <main className="space-y-6">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl font-semibold">Published Blogs</h1>
        </div>

        <div className="rounded-xl border border-border bg-background/85 p-4 shadow-sm sm:p-5">
          <SearchInput basePath="/admin/blogs/publishes" placeholder="Search published blogs..." />
          <CategoryPills categories={plainCategories} basePath="/admin/blogs/publishes" />
        </div>
  ...
  return (
    <main className="space-y-6">
      ...
      <div className="space-y-5 rounded-xl border border-border bg-background/85 p-4 shadow-sm sm:p-5">
        ...
        <Pagination page={page} totalPages={totalPages} basePath="/admin/blogs/publishes" />
      </div>
    </main>
  );
}
